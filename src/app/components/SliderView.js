                ...
                <div className={styles["main-description-container"]}>
                    <div className={`${styles["description-container"]} ${styles["center"]}`}>
                        <div className={styles["description"]} data-page={1}>
                            ...
                            <p>
                                En éste apartado podrá encontrar los documentos que deberá diligenciar para completar el proceso de matricula de manera exitosa. Para continuar con el proceso,
                                por favor, de clic en COMENZAR.
                            </p>
