    ...
    return (
        <section className={styles["slider-view-container"]}>
                ...
                <div className={styles["main-description-container"]}>
                    <div className={`${styles["description-container"]} ${styles["center"]}`}>
                        <div className={styles["description"]} data-page={1}>
                            ...
                            <p>
                                En éste panel podrá encontrar las instrucciones que debera seguir para realizar el proceso de matricula de manera exitosa. Para ver cada una de ellas por favor utilice los botenes de paginación, ubicados el parte inferior.\nEn cualquier moneto puede puede dar clic en COMENZAR para diligenciar los documentos.
                            </p>
            ...
            <div className={styles["slider-main-image-container"]}>
                    ...
                    <Banner images={props.images} sliderClassList={`${styles["image-container"]} ${styles["active"]} image${1}`}/>
            </div>
        </section>
    )
}